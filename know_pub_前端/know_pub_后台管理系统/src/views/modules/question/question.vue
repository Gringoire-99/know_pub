  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('kp_admin:question:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('kp_admin:question:delete')" :disabled="dataListSelections.length <= 0" type="danger"
    ...
    <el-table
      ...
      <el-table-column
        align="center"
        header-align="center"
        label="作者id,需要根据id去user表中查找基础信息"
        prop="userId">
      </el-table-column>
      <el-table-column
        align="center"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/kp_admin/question/list'),
        method: 'get',
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornUrl('/kp_admin/question/delete'),
          method: 'post',
